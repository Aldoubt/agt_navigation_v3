...
| What are V4-specific gates and which have evidence? | [acceptance/V4_ACCEPTANCE_MATRIX.md](acceptance/V4_ACCEPTANCE_MATRIX.md) | [../V4_MIGRATION_REPORT.md](../V4_MIGRATION_REPORT.md), [ACCEPTANCE.md](ACCEPTANCE.md) | Matrix is planned gates; dated report is evidence, not approval |
