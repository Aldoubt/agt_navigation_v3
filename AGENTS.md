...
- `/agt/odometry/local` — canonical odometry from the single selected LIO backend.
- `/agt/odometry/adapter_status` — shared readiness/latency diagnostics for either backend.
